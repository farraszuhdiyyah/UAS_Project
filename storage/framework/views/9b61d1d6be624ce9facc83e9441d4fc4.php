...
<?php $__env->startSection('content'); ?>
    ...
    <head>
        ...
        <!-- Favicons -->
        <link href="<?php echo e(asset('web/assets/img/favicon.png')); ?>') }}" rel="icon" />
        <link href="<?php echo e(asset('web/assets/img/apple-touch-icon.png')); ?>') }}" rel="apple-touch-icon" />
        ...
        <link href="<?php echo e(asset('web/assets/css/main.css')); ?>" rel="stylesheet" />
    </head>
    ...
    <body>
        ...
        <header id="header" class="header fixed-top d-flex align-items-center">
            <div class="container d-flex align-items-center justify-content-between">
                <a href="<?php echo e(url('/')); ?>" class="logo d-flex align-items-center me-auto me-lg-0">
            ...
            <div class="container">
                <div class="row justify-content-between gy-5">
                    ...
                    <div class="col-lg-5 order-1 order-lg-2 text-center text-lg-start">
                        <img src="<?php echo e(asset('web/assets/img/hero-img.png')); ?>" class="img-fluid" alt=""
                ...
                <div class="container" data-aos="fade-up">
                    ...
                    <div class="row gy-4">
                        <div class="col-lg-7 position-relative about-img"
                            style="background-image: url('<?php echo e(asset('web/assets/img/about.jpg')); ?>')" data-aos="fade-up"
                            data-aos-delay="150">
                        ...
                        <div class="col-lg-5 d-flex align-items-end" data-aos="fade-up" data-aos-delay="300">
                            <div class="content ps-0 ps-lg-5">
                                ...
                                <div class="position-relative mt-4">
                                    <img src="<?php echo e(asset('web/assets/img/about-2.jpg')); ?>" class="img-fluid"
                                        alt="" />
                            ...
                            <div class="row gy-5">
                                <?php $__currentLoopData = $produk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-lg-4 menu-item">
                                        ...
                                        <p class="price">Rp.<?php echo e($p->harga_jual); ?></p>
                                    </div>
                                ...
                                <div class="testimonial-item">
                                    <div class="row gy-4 justify-content-center">
                                        ...
                                        <div class="col-lg-2 text-center">
                                            <img src="<?php echo e(asset('web/assets/img/testimonials/testimonials-1.jpg')); ?>"
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item">
                                    <div class="row gy-4 justify-content-center">
                                        ...
                                        <div class="col-lg-2 text-center">
                                            <img src="<?php echo e(asset('web/assets/img/testimonials/testimonials-2.jpg')); ?>"
                                                class="img-fluid testimonial-img" alt="" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item">
                                    <div class="row gy-4 justify-content-center">
                                        ...
                                        <div class="col-lg-2 text-center">
                                            <img src="<?php echo e(asset('web/assets/img/testimonials/testimonials-3.jpg')); ?>"
                                                class="img-fluid testimonial-img" alt="" />
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="container" data-aos="fade-up">
                    ...
                    <div class="row gy-4">
                        <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up"
                            ...
                            <div class="chef-member">
                                <div class="member-img">
                                    <img src="<?php echo e(asset('web/assets/img/chefs/altaf.jpg')); ?>" class="img-fluid"
                                        alt="" />
                                    <div class="social">
                        ...
                        <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up"
                            ...
                            <div class="chef-member">
                                <div class="member-img">
                                    <img src="<?php echo e(asset('web/assets/img/chefs/ikma.jpg')); ?>" class="img-fluid"
                                        alt="" />
                                    <div class="social">
                                        <a href=""><i class="bi bi-twitter"></i></a>
                                        <a href=""><i class="bi bi-facebook"></i></a>
                        ...
                        <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up"
                            ...
                            <div class="chef-member">
                                <div class="member-img">
                                    <img src="<?php echo e(asset('web/assets/img/chefs/farras.jpg')); ?>" class="img-fluid"
                                        alt="" />
                                    <div class="social">
                                        <a href=""><i class="bi bi-twitter"></i></a>
                                        <a href=""><i class="bi bi-facebook"></i></a>
                        ...
                        <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up"
                            ...
                            <div class="chef-member">
                                <div class="member-img">
                                    <img src="<?php echo e(asset('web/assets/img/chefs/ibnu.jpg')); ?>" class="img-fluid"
                                        alt="" />
                                    <div class="social">
                                        <a href=""><i class="bi bi-twitter"></i></a>
                                        <a href=""><i class="bi bi-facebook"></i></a>
        ...
        <script src="<?php echo e(asset('web/assets/vendor/purecounter/purecounter_vanilla.js')); ?>"></script>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\farra\Downloads\restoran\resto\resources\views/tampilan.blade.php ENDPATH**/ ?>